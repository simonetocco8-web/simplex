...
class Zend_Validate_Hostname extends Zend_Validate_Abstract
{
    ...
    public function isValid($value)
    {
        ...
        if ((count($domainParts) > 1) && (strlen($value) >= 4) && (strlen($value) <= 254)) {
            ...
            $origenc = ini_set('default_charset', 'UTF-8'); //iconv_get_encoding('internal_encoding');
            ini_set('default_charset', 'UTF-8'); //iconv_set_encoding('internal_encoding', 'UTF-8');
            do {
                // First check TLD
                $matches = array();
            ...
            ini_set('default_charset', 'UTF-8');//iconv_set_encoding('internal_encoding', $origenc);
